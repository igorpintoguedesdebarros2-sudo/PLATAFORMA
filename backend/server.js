...
// =====================================================
//
// SOMENTE O CÓDIGO DEFINE OS PREÇOS.
//
// O FRONTEND NÃO ENVIA VALOR.
//
// O ADMINISTRADOR NÃO DEFINE VALOR.
//
// O STRIPE RECEBE O VALOR DESTE OBJETO.
//
// =====================================================
    ...
    async (req, res) => {
        ...
        try {
            ...
            if (
                ...
                // A senha pode ser utilizada 2 vezes
