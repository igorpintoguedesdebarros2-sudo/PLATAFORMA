...
// =====================================================
//
// SOMENTE VOCÊ ALTERA ESTES VALORES.
//
// O FRONTEND NÃO ENVIA O PREÇO.
// O ADMINISTRADOR NÃO DEFINE O PREÇO.
// O BACKEND SEMPRE USA O VALOR ABAIXO.
//
// =====================================================
...
async (req, res) => {
    ...
    try {
        ...
        if (
            ...
            // A senha pode ser usada duas vezes
        ...
        // -------------------------------------------------
        // RETORNAR DADOS PARA SUCESSO.JS
        // -------------------------------------------------
