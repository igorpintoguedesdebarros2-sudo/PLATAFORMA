...
const conteudos = {
  pdfs: [
    { id: 1, titulo: "Apostila 1", arquivo: "/public/IMGs/portugues/00-apostila-completa-portugues-e-formaao-militar-naval_compress.pdf" },
  ],
  videos: [],
};
  ...
  return (
    <div className="container">
     <h2>Curso PORTUGUÊS</h2>
      ...
      {/* ---------- LINK FINAL ---------- */}
      {finalizado && (
  <button onClick={() => window.open("/src/PROVA-PORTUGUES", "_blank")}>
    ACESSAR PROVA
  </button>
)}
