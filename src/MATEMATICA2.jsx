...
const conteudos = {
  pdfs: [
    { id: 1, titulo: "Apostila 1", arquivo: "/public/IMGs/matematica/apostila de matemática2.pdf" },
  ],
  videos: [],
};
  ...
  return (
    <div className="container">
     <h2>Curso - MATEMÁTICA2</h2>
      ...
      {/* ---------- LINK FINAL ---------- */}
      {finalizado && (
  <button onClick={() => window.open("/src/PROVA-MATEMATICA", "_blank")}>
    ACESSAR PROVA
  </button>
)}
