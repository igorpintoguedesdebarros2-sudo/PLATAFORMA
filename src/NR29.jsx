...
const conteudos = {
  pdfs: [
    { id: 1, titulo: "Apostila 1", arquivo: "/public/IMGs/NR 29/NR-29.pdf" },
  ],
  videos: [],
};
...
export default function AcessoProtegido() {
  ...
  return (
    <div className="container">
     <h2>CURSO NR29 - PORTUARIO</h2>

<img
  src="/public/IMGs/29.jpg"
  alt="Imagem do curso"
  style={{
    width: "100%",
    maxWidth: "400px",
...
/>
      ...
      {/* ---------- LINK FINAL ---------- */}
      {finalizado && (
  <button onClick={() => window.open("/src/PROVA-NR29", "_blank")}>
    ACESSAR PROVA
  </button>
)}
